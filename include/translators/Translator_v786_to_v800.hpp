#pragma once
// ─────────────────────────────────────────────────────────────────────────────
// Translator: 1.21.7x (proto 786) → 1.21.8x (proto 800)
// Source: GlacieTeam/ProtocolLib releases table (авторитетный источник)
//
// КАК ЗАПОЛНЯТЬ:
//   1. Найди changelog между 1.21.7x и 1.21.8x на minecraft.wiki или
...
class Translator_v786_to_v800 final : public IVersionTranslator {
public:
    ...
    [[nodiscard]] std::unique_ptr<IPacket> translate(
        ...
        // ══════════════════════════════════════════════════════════════════════
        // TODO: Вставить реальные case-ы после изучения diff 1.21.7x→1.21.8x
        //
        // ШАБЛОН для поля, добавленного в 1.21.8x:
        //
        ...
        //         // Клиент 1.21.7x не знает mNewField — обнуляем/убираем
        //         sg->mNewFieldAddedIn800 = {};
        //     } else {
        //         // Сервер 1.21.8x ожидает mNewField — проставляем дефолт
        //         // (уже нулевой, но явно)
        //     }
        //     return packet;
        // }
        //
        // ШАБЛОН для нового пакета, появившегося в 1.21.8x:
        //
        // case MinecraftPacketIds::SomeNewPacket: {
        //     if (direction == TranslateDirection::Clientbound) {
        //         return nullptr; // Клиент 1.21.7x не знает этот пакет — дроп
        //     }
        //     // Serverbound: такой пакет клиент 1.21.7x послать не может —
